...
def fetch_all_rows(table_name):
    ...
    while True:
        # Fetch a chunk of 1000 rows
        response = (
            supabase.table(table_name)
            .select("*")
            .eq("used", "false")
            .range(start, start + page_size - 1) # Inclusive bounds (e.g., 0 to 999)
            .execute()
        )
...
det_coords = [-21.8877932497327, -49.013558624205324]
...
while True:
    ...
    messages = fetch_all_rows("raw_msg")
    # print(messages)
